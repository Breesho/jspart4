...
let changeSecondElement = function (array) {
  let languages = [ 'javascript', 'test', 'mysql', 'c++' ];
  let change = languages.splice(1,1, 'php');
  return languages;
    // return array=[1]='php';
}
...
let addAtTheEnd = function (array) {
  let languages = [ 'javascript', 'php', 'mysql', 'c++' ];
  let change = languages.push('ruby', 'python');
...
let addAtFirst = function (array) {
  let languages = [ 'javascript', 'php', 'mysql', 'c++' ];
  let change = languages.push('ruby', 'python') + languages.unshift('html', 'css');
